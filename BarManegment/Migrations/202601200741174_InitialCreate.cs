    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Account", t => t.ReceivableAccountId)
                ...
                c => new
                    {
                        ...
                        AnnualIncrementAmount = c.Decimal(precision: 18, scale: 2),
                ...
                c => new
                    {
                        ...
                        AllowedRadius = c.Int(nullable: false),
                        IsActive = c.Boolean(nullable: false),
                    })
                .PrimaryKey(t => t.Id);
                ...
                c => new
                    {
                        ...
                        IsSaturdayOff = c.Boolean(nullable: false),
                        IsSundayOff = c.Boolean(nullable: false),
                        IsMondayOff = c.Boolean(nullable: false),
                        IsTuesdayOff = c.Boolean(nullable: false),
                        IsWednesdayOff = c.Boolean(nullable: false),
                        IsThursdayOff = c.Boolean(nullable: false),
                        IsFridayOff = c.Boolean(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.HourlyPermission", "EmployeeId", "dbo.Employee");
            ...
            DropForeignKey("dbo.AttendanceLog", "EmployeeId", "dbo.Employee");
            ...
            DropForeignKey("dbo.LoanTypes", "ReceivableAccountId", "dbo.Account");
            ...
            DropIndex("dbo.HourlyPermission", new[] { "EmployeeId" });
            ...
            DropIndex("dbo.AttendanceLog", new[] { "EmployeeId" });
            ...
            DropIndex("dbo.LoanTypes", new[] { "ReceivableAccountId" });
            ...
            DropTable("dbo.HourlyPermission");
